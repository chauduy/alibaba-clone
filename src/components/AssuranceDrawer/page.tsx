            ...
            <DrawerTrigger className="w-full text-[10px] md:text-sm">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-x-1">
                        ...
                        <div className="text-xs font-bold md:text-[16px]">Trade Assurance</div>
                    </div>
                ...
                <div className="bg-white p-4 md:p-6">
                    <div className="rounded-md bg-[#FFF0E6] p-4 text-[11.5px] md:p-6 md:text-sm">
                        ...
                        <div className="mt-2 flex items-center">
                            ...
                            />
                            <div className="mr-12 mt-1 md:mr-16 md:mt-2">Product quality </div>
                            <Image
                    ...
                    <div className="mt-3 rounded-md bg-[#F7F8FA] p-4 text-[11.5px] md:p-6 md:text-sm">
                        <div className="mb-3 text-sm md:text-[16px]">Secure payment options</div>
                        ...
                        <div className="mt-2 text-sm md:text-[16px]">
                            ...
                            <div className="mt-3 font-bold italic text-[#1E56EF]">Pay Later</div>
                            <div className="mt-0.5 text-xs text-[#666666] md:text-sm">
                    ...
                    <div className="mt-3 rounded-md bg-[#F7F8FA] p-4 text-[11.5px] md:text-sm">
                        <div className="text-sm md:text-[16px]">Other trade services</div>
                        <div className="mb-2 mt-3 flex items-center gap-x-2">
                            <Image
                                ...
                                className="w-5 md:w-7"
                            />
                            <div className="text-sm md:text-[16px]">Alibaba.com Logistics</div>
                        </div>
                        ...
                        <div className="mb-2 mt-3 flex items-center gap-x-2">
                            <Image
                                ...
                                className="w-5 md:w-7"
                            />
                            <div className="text-sm md:text-[16px]">Inspection Solutions</div>
                        </div>
                        <ol className="text-[#666666]">
